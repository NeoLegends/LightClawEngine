...
namespace LightClaw.Engine.Core
{
    ...
    public struct Vector3 : ICloneable, IEquatable<Vector3>, IComparable<Vector3>
    {
        ...
        /// <summary>
        /// Creates a new <see cref="Vector3"/> from the given <see cref="System.Drawing.Point"/>.
        /// </summary>
        /// <param name="point">The <see cref="System.Drawing.Point"/> to create a new <see cref="Vector3"/> from.</param>
        public Vector3(System.Drawing.Point point) : this(point.X, point.Y) { }

        /// <summary>
        /// Creates a new <see cref="Vector3"/> from the given <see cref="System.Drawing.Point"/>.
        /// </summary>
        /// <param name="point">The <see cref="System.Drawing.Point"/> to create a new <see cref="Vector3"/> from.</param>
        public Vector3(System.Drawing.PointF point) : this(point.X, point.Y) { }
        ...
        public Vector3(System.Drawing.Color color) : this(color.R, color.G, color.B) { }

#endif

        /// <summary>
        /// Creates a new <see cref="Vector3"/> from the given <see cref="Vector2"/>.
        /// </summary>
        /// <param name="vector">The <see cref="Vector2"/> to create this <see cref="Vector3"/> from.</param>
        public Vector3(Vector2 vector) : this(vector.X, vector.Y) { }
        ...
        /// <summary>
        /// Creates a new <see cref="Vector3"/> from the given <see cref="Color"/>.
        /// </summary>
        /// <param name="color">The <see cref="Color"/> to create a <see cref="Vector3"/> from.</param>
        public Vector3(Color color) : this(color.R, color.G, color.B) { }

        /// <summary>
        /// Creates a new <see cref="Vector3"/> setting the X and Y value (and Z to 0).
        /// </summary>
        ...
        /// <summary>
        /// Explicitly converts the given <see cref="Vector2"/> into a <see cref="Vector3"/>.
        /// </summary>
        ...
        /// <summary>
        /// Explicitly converts the given <see cref="Color"/> into a <see cref="Vector3"/>.
        /// </summary>
