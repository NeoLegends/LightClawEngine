...
namespace LightClaw.Engine.Core
{
                            ...
                            IEquatable<Vector2>, IComparable<Vector2>
    {
        ...
        /// <summary>
        /// The length of the <see cref="Vector2"/>.
        /// </summary>
        public float Length
        {
            get
        ...
        /// <summary>
        /// Explicitly converts the specified <see cref="Color"/> into a <see cref="Vector2"/>.
        /// </summary>
        /// <param name="color">The <see cref="Color"/> to convert.</param>
        /// <returns>The converted <see cref="Vector2"/>.</returns>
        public static explicit operator Vector2(Color color)
        {
            return new Vector2(color);
        }
        ...
        public static explicit operator OpenTK.Vector2d(Vector2 vector)
        {
