...
{
    /// <summary>
    /// Represents an attachment validator that allows to declare dependencies of the <see cref="Component"/> on
    /// other <see cref="Component"/>s.
    /// </summary>
    /// <remarks>
    /// Dependency on <see cref="Transform"/> and <see cref="Coroutines.CoroutineController"/> do not (!) have
    /// to be declared explicitly, they will be managed by the <see cref="GameObject"/> and automatically added.
    /// </remarks>
