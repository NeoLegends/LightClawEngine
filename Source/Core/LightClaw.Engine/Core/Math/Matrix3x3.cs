...
namespace LightClaw.Engine.Core
{
    ...
    public struct Matrix3x3 : IEquatable<Matrix3x3>
    {
        ...
        /// </summary>
        public static Matrix3x3 Random
        {
            get
            {
                return new Matrix3x3(RandomF.GetSingles(9));
            }
        }
        ...
        public float this[int row, int column]
        {
            get
            {
                ...
                Contract.Requires<ArgumentOutOfRangeException>(column >= 0 && column < 3);
        ...
        public override int GetHashCode()
        {
            return HashF.GetHashCode(
                HashF.GetHashCode(this.M11, this.M12, this.M13),
                HashF.GetHashCode(this.M21, this.M22, this.M23),
                HashF.GetHashCode(this.M31, this.M32, this.M33)
            );
        }
