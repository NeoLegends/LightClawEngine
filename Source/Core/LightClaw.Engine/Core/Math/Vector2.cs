    ...
    public struct Vector2 : IEquatable<Vector2>
    {
        ...
        public float[] Array
        {
            ...
            set
            {
                ...
                Contract.Requires<ArgumentOutOfRangeException>(value.Length == 2);
        ...
        public float this[int index]
        {
            get
            {
                Contract.Requires<ArgumentOutOfRangeException>(index >= 0 && index < 2);
        ...
        public override bool Equals(object value)
        {
            ...
            return (value is Vector2) ? this.Equals((Vector2)value) : false;
        }
