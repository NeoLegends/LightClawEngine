...
namespace LightClaw.Engine.Graphics.OpenGL
{
    ...
    public class LinkingFailedException : OpenGLException
    {
        ...
        public LinkingFailedException(string message)
            : base(message)
        {
        }
        ...
        public LinkingFailedException(string message, string infoLog)
        ...
        public LinkingFailedException(string message, string infoLog, int errorCode)
        ...
        /// <param name="message">The exception message.</param>
        /// <param name="errorCode">The result code.</param>
        public LinkingFailedException(string message, int errorCode)
        ...
        public LinkingFailedException(string message, Exception inner)
            : base(message, inner)
        {
        }
        ...
        protected LinkingFailedException(SerializationInfo info, StreamingContext context)
            : base(info, context)
        {
        }
    }
