...
namespace LightClaw.Engine.Graphics.OpenGL
{
    ...
    public class CompilationFailedException : OpenGLException
    {
        ...
        public CompilationFailedException(string message, string infoLog) : base(message, infoLog) { }
        ...
        public CompilationFailedException(string message, string infoLog, int errorCode) : base(message, infoLog, errorCode) { }
        ...
        /// <param name="message">The exception message.</param>
        /// <param name="errorCode">The result code.</param>
        public CompilationFailedException(string message, int errorCode) : base(message, errorCode) { }
